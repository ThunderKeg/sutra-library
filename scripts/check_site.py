...
def main() -> int:
    ...
    require("20260723-audio-follow-v1" in app_script, "app version was not bumped for audio following")
    require("sutra-library-v17-20260723-audio-follow" in service_worker, "service worker cache version was not bumped")
    ...
    require('id="audioSeekOnScrollToggle"' in reader_html and 'id="audioResumeFollowToggle"' in reader_html, "audio/text preference controls missing")
    require('id="audioResumeFollowButton"' in reader_html and "resumeAudioFollowing" in reader_script, "manual audio-follow resume control missing")
    ...
    require("seekAudioToVisibleText" in reader_script and "finishManualScroll" in reader_script, "text-to-audio scrolling linkage missing")
