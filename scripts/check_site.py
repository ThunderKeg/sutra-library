...
def main() -> int:
    ...
    require("sutra-library-v16-20260723-audio-sources" in service_worker, "service worker cache version was not bumped")
    ...
    require("FIRST_VOLUME_AUDIO" in reader_script and reader_script.count(".m4a") == 11, "first-volume audio map is incomplete")
