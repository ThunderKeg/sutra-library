...
- 网站收录、呈现、播放或提供下载的任何资源，包括但不限于书籍正文、原始 PDF、影印页、音频、图片、字体和视频，都必须在 `README.md` 或相应专题文档中明确说明来源；仅在数据文件或网站页面中记录不能替代项目文档说明。
- 来源说明至少应包含资源名称及版本、作者／译者／发布方等责任主体，以及可追溯的原始页面或下载链接；已知的授权或许可信息也应一并记录。
- 新增、替换或移除网站资源时，必须在同一次变更中同步更新来源说明；来源不明或无法追溯的资源不得发布。
